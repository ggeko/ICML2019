...
############################################################################
out_dir = 'WideResNet_SGD_One_Manual_Fluc_Margin'
...
wide_factor = 1
############################################################################
model_list = ['ResNet10', 'ResNet22', 'ResNet34']
############################################################################
...
"""
############################################################################
model_list = ['ResNet34', 'ResNet16', 'ResNet22']
############################################################################
batch_list = [500, 500, 500]
epoch_list = [5, 5, 5]
trig_list  = [  5,   5,   5]
...
def main():
    ...
    train_ds, test_ds = get_dataset(
        ds_name, 'ResNet', data_dir, ds_size, ds_normalized)
    ########################################################################
    ...
    # end for
    ########################################################################
    with open('{}/wide_resnet_sgd_one_manual_fluc_margin.pkl'.format(
            out_dir), 'wb') as f:
