...
"""
############################################################################
model_list = ['VGG_C3L3_WOB', 'VGG_C4L3_WOB']
batch_list = [500, 500]
num_calc = 2
############################################################################
"""
...
def main():
    ...
    train_ds, test_ds = get_dataset(
        ds_name, 'VGG', data_dir, ds_size, ds_normalized, ds_amount)
    ########################################################################
    ...
    for ds_name in ds_list:
        ...
        ####################################################################
        file_name = '{}/vgg_fluctuation_data_{}.pkl'.format(out_dir, ds_name)
    ...
    ########################################################################
    file_name = '{}/vgg_fluctuation_data_all.pkl'.format(out_dir)
    with open(file_name, 'wb') as f:
